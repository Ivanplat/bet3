...
CREATE TABLE IF NOT EXISTS `settings` (
  ...
  `system_id` varchar(120) NOT NULL,
  `system_password` varchar(120) NOT NULL,
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `admin_yandex` varchar(40) NOT NULL,
  ...
  `com_output` int(11) NOT NULL,
  `ref_input` int(11) NOT NULL,
  `ref_status` varchar(10) NOT NULL,
  `ref_win` int(11) NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `yandex` varchar(40) NOT NULL,
  `balance` float NOT NULL,
  `visa` varchar(40) NOT NULL,
  `refer` int(11) NOT NULL,
  `sum_ref` varchar(40) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
#####################################
...
(6, 'Оповещения', '/bukmeker/notifications', 'notifications.png', 1),
(7, 'Реферальная программа', '/bukmeker/ref', 'referals.png', 1),
(8, 'Live-результаты', '/bukmeker/live', 'live.png', 1),
(9, 'Помощь', '/faq', 'help.png', 1),
(10, 'Выход', '/bukmeker/exit', 'exit.png', 1);